      ...
      <section className="guide__hero">
        <div className="guide__hero__container">
          ...
          <p className="guide__hero__paragraph">
            Here you will find guides geared towards server owners. Learn about
            how to get started with Desire, or visit our reccomended guides in
            both video and written formats.
          </p>
        </div>
        <img
